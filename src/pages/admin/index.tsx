                ...
                <form>
                  <div className="card-body">
                    <div className="form-group">
                      <label htmlFor="exampleInputEmail1">ชื่อโครงงาน*</label>
                      <input
                        type="email"
                    ...
                    <div className="form-group">
                      <label htmlFor="exampleInputPassword1">รายระเอียด*</label>
                      <input
                        type="password"
                        className="form-control"
                ...
                >
                  <form>
                    <div className="card-body">
                      ...
                      <div className="form-group">
                        <label htmlFor="exampleInputFile">แนบไฟล์ PDF*</label>
                        <div className="input-group">
                          <div className="custom-file">
                            <input
                              type="file"
                    ...
                    <div className="card-body">
                      <div className="form-group">
                        ...
                        >
                          ...
                          <option value="option2">เพิ่มข้อมูลด้วยไฟล์</option>
                          <option value="option2">เพิ่มข้อมูลรายบุคคล</option>
                        </select>
                      </div>
                      <div className="form-group">
                        <label htmlFor="exampleInputEmail1">ชื่อโครงงาน*</label>
                      ...
                      <div className="form-group">
                        <label htmlFor="exampleInputFile">แนบไฟล์ excel*</label>
                        <div className="input-group">
                          <div className="custom-file">
                            <input
                              type="file"
